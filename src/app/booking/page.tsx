...
export default function Booking() {
  ...
  return (
    <main className="w-[100%]  flex flex-wrap flex-col items-center space-y-4 ">
      ...
      <div
        className="w-[60%] h-[60vh] flex flex-wrap flex-col border border-black items-center m-10 rounded-xl justify-center
                      space-y-12 mb-12"
      >
        <div className="text-3xl m-5 my-10 text-center">
